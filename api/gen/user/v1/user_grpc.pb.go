...
const (
	...
	UserService_HasPermission_FullMethodName    = "/user.v1.UserService/HasPermission"
	UserService_ReplaceUserRoles_FullMethodName = "/user.v1.UserService/ReplaceUserRoles"
)
...
type UserServiceClient interface {
	...
	ReplaceUserRoles(ctx context.Context, in *ReplaceUserRolesRequest, opts ...grpc.CallOption) (*ReplaceUserRolesResponse, error)
}
...
func (c *userServiceClient) ReplaceUserRoles(ctx context.Context, in *ReplaceUserRolesRequest, opts ...grpc.CallOption) (*ReplaceUserRolesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReplaceUserRolesResponse)
	err := c.cc.Invoke(ctx, UserService_ReplaceUserRoles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	ReplaceUserRoles(context.Context, *ReplaceUserRolesRequest) (*ReplaceUserRolesResponse, error)
...
func (UnimplementedUserServiceServer) ReplaceUserRoles(context.Context, *ReplaceUserRolesRequest) (*ReplaceUserRolesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReplaceUserRoles not implemented")
}
...
func _UserService_ReplaceUserRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReplaceUserRolesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).ReplaceUserRoles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_ReplaceUserRoles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ReplaceUserRoles(ctx, req.(*ReplaceUserRolesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_ReplaceUserRoles_Handler,
		},
	},
