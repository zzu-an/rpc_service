.PHONY: test test-race vet verify-v01 verify-v02 verify-v02-boundary verify-v03 verify-v03-boundary verify-v042 verify-v042-boundary labs-test labs-race labs-bench migrate-up migrate-down migrate-version
